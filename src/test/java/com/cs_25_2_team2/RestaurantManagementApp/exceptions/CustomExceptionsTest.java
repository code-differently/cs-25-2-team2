...
/**
 * Test class for custom exceptions and standard Java exceptions used in the application.
 * This includes both our custom exceptions and standard Java exceptions that we use
 * for input validation and state checks.
 */
