...
/**
 * Exception thrown when an operation violates order state business rules. This is different from
 * IllegalStateException as it represents domain-specific business logic violations related to order
 * processing workflow.
 */
public class InvalidOrderStateException extends RuntimeException {
  ...
  public InvalidOrderStateException(int orderId, String currentState, String attemptedOperation) {
    super(
        String.format(
            "Cannot perform '%s' operation on Order #%d in state '%s'",
