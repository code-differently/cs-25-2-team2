...
/**
 * Chef class that manages kitchen operations and order processing.
 * Extends Staff and handles all order management responsibilities.
 */
public class Chef extends Staff {
  ...
  public void completeOrder(int orderId) {
    ...
    System.out.println("Chef " + getName() + " completed order #" + orderId + " - Ready for delivery!");
  }
  ...
  public void updateOrderStatus(int orderId, Order.Status newStatus) {
    ...
    System.out.println("Chef " + getName() + " updated order #" + orderId + " status to " + newStatus);
  }
  ...
  public void addSpecialRequest(int orderId, String request) {
    ...
    System.out.println("Chef " + getName() + " added special request to order #" + orderId + ": " + request);
  }
  ...
  public void sendToDelivery(int orderId, Delivery deliveryStaff) {
    ...
    System.out.println("Chef " + getName() + " sent order #" + orderId + " to delivery staff " + deliveryStaff.getName());
  }

  @Override
  public String toString() {
    return String.format("Chef{name='%s', id='%s', orders=%d, activeOrders=%d}", 
